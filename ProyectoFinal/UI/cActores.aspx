<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="cActores.aspx.cs" Inherits="ProyectoFinal.UI.WebForm6" %>
            ...
            <div class="main-login main-center">
                ...
                <div class="form-group">
                    ...
                    <asp:GridView ID="cGridView" AutoGenerateColumns="false" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                        ...
                        <Columns>
                            <asp:BoundField DataField="ActorId" HeaderText="ID" ReadOnly="true" />
                            <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
                            <asp:BoundField DataField="FechaDebut" HeaderText="Fecha de debut" ReadOnly="true" />
                        </Columns>
