<%@ Page Title="" Language="C#" MasterPageFile="~/UI/Site.Master" AutoEventWireup="true" CodeBehind="cClientes.aspx.cs" Inherits="ProyectoFinal.UI.WebForm8" %>
                ...
                <div class="form-group">
                    <div class="cols-sm-10">
                        ...
                        <asp:DropDownList ID="CampoFiltrarDropDownList" class="form-control" runat="server">
                            ...
                            <asp:ListItem Text="Puntos" Value="2" />
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <asp:GridView ID="cGridView" AutoGenerateColumns="false" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Horizontal">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="FechaNacimiento" HeaderText="Fecha Nacimiento" ReadOnly="true" />
